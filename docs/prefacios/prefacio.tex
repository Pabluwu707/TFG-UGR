...
\vspace{0.5cm}
\noindent\textbf{Palabras clave}: \textit{software libre, ingenieria de software, desarrollo web, TypeScript, Javascript, HTML, INDIGO, TCP/IP}
\vspace{0.7cm}
...
\end{center}
\vspace{0.5cm}
\noindent\textbf{Keywords}: \textit{open source, software engineering, web development, TypeScript, JavaScript, HTML, INDIGO, TCP/IP}, \textit{floss}
\vspace{0.7cm}
...
%A mi familia y amigos, por aguantarme en mis peores momentos 
