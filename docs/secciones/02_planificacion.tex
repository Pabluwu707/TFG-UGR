...
Considerando las características y requisitos planteados para el proyecto, se consideró inicialmente el uso de una \textbf{metodología ágil iterativa}, como Scrum\cite{scrum}, Kanban\cite{kanban} o Extreme Programming\cite{xp}. Una metodología iterativa nos permitiría establecer una planificación flexible desde el primer momento, con la que poder establecer hitos y realizar revisiones periódicas con el cliente para asegurar el progreso adecuado del proyecto.

Sin embargo, es importante tener en cuenta que este proyecto se ha realizado en solitario. \textbf{Las metodologías ágiles están diseñadas principalmente para equipos colaborativos}, y requieren la coordinación de diversos roles, por lo que \textbf{será necesario adaptar estas metodologías para un proceso de desarrollo en solitario}.

Por tanto, se han elegido y adaptado las técnicas y herramientas de mayor interés de las metodologías de desarrollo ágil para proponer una \textbf{metodología personalizada} para este proyecto. A continuación se detallan los elementos de esta: 
...
Se definen a continuación las herramientas utilizadas durante el desarrollo del proyecto
...
Aunque se consideraron otras alternativas como Jira\cite{jira}, estas están orientadas para la gestión de equipos de desarrollo con múltiples integrantes y roles, siendo más compleja para un proyecto realizado en individual como este. En comparación, Notion será una herramienta mucho más fácil de manejar.
...
En la siguiente sección dividiremos el proyecto en varias fases, siguiendo la metodología descrita en el anterior apartado, y asignaremos una serie de historias de usuario a cada sprint.

\subsection{Fases del proyecto}
Se realizó una estimación inicial de las distintas \textbf{fases} que compondrían el proyecto, asignando a cada una una duración estimada y un determinado objetivo. A continuación se detallan las fases del proyecto:
...
\begin{figure}[h]
	\centering
	\hspace*{-3.3cm}  
	\includegraphics[width=\paperwidth]{img/gantt.png}
...
Se ha realizado la siguiente asignación de las historias de usuario, en función de sus prioridades y los objetivos de cada iteración antes definida:
...
{\ul \textbf{Fase de desarrollo}} & {\ul \textbf{Historias asignadas}}                                                                                                                                             \\ \hline
\textbf{Sprint 1}                 & \begin{tabular}[c]{@{}l@{}}· INDIGO.1.1\\ · INDIGO.1.3\\ · INDIGO.1.2\\ · INDIGO.1.5\\ · INDIGO.1.8\\ · INDIGO.1.9\end{tabular}                                                \\ \hline
\textbf{Sprint 2}                 & \begin{tabular}[c]{@{}l@{}}· INDIGO.1.4\\ · INDIGO.1.6\\ · INDIGO.1.7\\ · INDIGO.1.10\\ · INDIGO.1.11\\ · INDIGO.1.12\end{tabular}                                             \\ \hline
\textbf{Sprint 3}                 & \begin{tabular}[c]{@{}l@{}}· INDIGO.2.1\\ · INDIGO.2.2\\ · INDIGO.2.3\\ · INDIGO.2.4\\ · INDIGO.2.5\\ · INDIGO.2.7\\ · INDIGO.2.9\\ · INDIGO.2.11\\ · INDIGO.2.12\end{tabular} \\ \hline
\textbf{Sprint 4}                 & \begin{tabular}[c]{@{}l@{}}· INDIGO.2.6\\ · INDIGO.2.8\\ · INDIGO.2.10\\ · INDIGO.2.13\\ · INDIGO.2.14\\ · INDIGO.2.15\\ · INDIGO.2.16\end{tabular}                            \\ \hline
\end{tabular}
\caption{Asignación de hsitorias de usuario por sprint.}
\end{table}
%
...
Adicionalmente, se ha considerado el coste del equipo utilizado en el desarrollo del proyecto. Este se ha llevado a cabo en un \textbf{ordenador portátil Medion Erazer P675}, cuyo valor es de \textbf{892,45 euros}\cite{medion}. Asumiendo que la vida útil del portátil será de 3 años (36 meses), se calcula un gasto de \textbf{24,79 euros por mes de uso}. Se asume que los dispositivos astronómicos sobre los que se realizarán las pruebas serán provistos por el cliente y no supondrán ningún coste adicional.
...
Salario mensual: ingeniero junior      &  1         		  &        7.668 € (1.917 €/mes, 4 meses)    \\ \hline
Material: Medion Erazer P675   & 1 				  &          99,16 € (24,75€/mes)      					\\ \hline
Coste total del proyecto         		  &          -         & \textbf{7.767,16 €} 						\\ \hline
\end{tabular}
